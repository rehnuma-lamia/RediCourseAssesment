...
function AboutPage() {
  let items = [
    ...
    {
      title: "To become a student",
      details:
        "You know the basic use of the computer (eg. email, web browser, Excel, PowerPoint).You can communicate in English (speaking, listening and writing).You are 18 years and older We give priority to people with a forced migration background.",
    },
  ];
  return (
    <div>
